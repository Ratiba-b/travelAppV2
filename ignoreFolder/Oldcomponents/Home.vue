<template>
  ...
  <section class="mb-8 py-20 text-white text-center relative">
    ...
    <div class="container mx-auto">
      <div class="text-white main-header-content">
        <h1 class="font-bold text-5xl mb-5">Voyager et être organisé</h1>
  ...
  <section class="container mx-auto">
    <div class="bg-white rounded border border-gray-200 relative flex flex-col">
      <div class="px-6 pt-6 pb-5 font-bold border-b border-gray-200">
        <span class="card-title">Planifiez votre prochain voyage</span>
        <!-- Icon -->
      </div>
      <div>
        <p class="w-full md:w-8/12 mx-auto">
  ...
  <div class="fixed bottom-0 left-0 bg-white px-4 py-2 w-full">
    ...
    <div class="text-center">
      <span class="song-title font-bold">Footer</span> by
      <span class="song-artist">travelapp</span>
    </div>
