...
<template>
    ...
    <div class="mx-auto max-w-7xl px-2 sm:px-4 lg:px-8">
      <div class="flex h-16 justify-between">
          ...
          <div class="w-full max-w-lg lg:max-w-xs">
            ...
            <div class="relative text-white focus-within:text-gray-400">
              ...
              <input
                id="search"
                name="search"
                class="block w-full rounded-md border-transparent bg-sky-400 py-2 pl-10 pr-3 text-base leading-5 placeholder-white focus:border-white focus:bg-white focus:text-gray-900 focus:placeholder-gray-400 focus:outline-none focus:ring-0 sm:text-sm"
                placeholder="Search"
                type="search"
              />
            </div>
        ...
        <div class="hidden lg:ml-4 lg:flex lg:items-center">
          <button
            type="button"
            class="flex-shrink-0 rounded-full bg-sky-500 p-1 text-sky-200 hover:text-white focus:outline-none focus:ring-2 focus:ring-white focus:ring-offset-2 focus:ring-offset-sky-500"
          >
          ...
          <Menu as="div" class="relative ml-4 flex-shrink-0">
            <div>
              <MenuButton
                class="flex rounded-full bg-sky-500 text-sm focus:outline-none focus:ring-2 focus:ring-white focus:ring-offset-2 focus:ring-offset-sky-500"
              >
    ...
    <DisclosurePanel class="lg:hidden">
      <div class="space-y-1 px-2 pt-2 pb-3">
        <DisclosureButton
          ...
          as="a"
          :href="item.href"
          class="block rounded-md py-2 px-3 text-base font-medium text-white hover:bg-sky-400 hover:text-white"
      ...
      <div class="border-t border-sky-500 pt-4 pb-3">
        <div class="flex items-center px-4">
          ...
          <button
            type="button"
            class="ml-auto flex-shrink-0 rounded-full bg-sky-500 p-1 text-sky-200 hover:text-white focus:outline-none focus:ring-2 focus:ring-white focus:ring-offset-2 focus:ring-offset-sky-500"
          >
        ...
        <div class="mt-3 px-2">
          <DisclosureButton
            ...
            as="a"
            :href="item.href"
            class="block rounded-md py-2 px-3 text-base font-medium text-sky-200 hover:bg-sky-400 hover:text-white"
            >{{ item.name }}</DisclosureButton
          >
        </div>
      </div>
  ...
  <!-- Breadcrumb -->
  <nav
    class="hidden border-b border-gray-200 bg-white lg:flex"
    ...
    <form>
      <div class="space-y-6">
        ...
        <div class="flex justify-end">
          ...
          <button
            type="submit"
            class="ml-3 inline-flex justify-center rounded-md border border-transparent bg-sky-500 py-2 px-4 text-sm font-medium text-white shadow-sm hover:bg-sky-600 focus:outline-none focus:ring-2 focus:ring-sky-500 focus:ring-offset-2"
          >
            Create this project
          </button>
        </div>
